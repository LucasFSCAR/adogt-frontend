...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var patinhaButton: FloatingActionButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        patinhaButton = findViewById(R.id.show_own_pets)
        ...
        patinhaButton.setOnClickListener{
            val i = Intent(this@MainActivity, ManagePetsActivity::class.java)
            startActivity(i)
        }
    ...
    private fun loadUserInfo() {
        val email = UserInfo.user!!.email
        val call = UserController.getUserByEmail(email)
        call.enqueue(object : Callback<User> {
            override fun onResponse(call: Call<User>?, response: Response<User>?) {
                if (response != null && response!!.body() != null)
                    response!!.body()?.let { UserInfo.userData = it}
            }
